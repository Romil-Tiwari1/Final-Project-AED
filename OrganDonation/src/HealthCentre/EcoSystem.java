...
public class EcoSystem extends Organization {
    ...
    public void setUserAccountDirectory(UserAccountInventory userAccountDirectory) {
    ...
    public DonorDirectory getOrganDonorDirectory() {
        return donorDirectory;
    }

    public void setOrganDonorDirectory(DonorDirectory donorDirectory) {
        this.donorDirectory = donorDirectory;
    }
