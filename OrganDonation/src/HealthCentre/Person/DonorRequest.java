...
// Getter Setter Functions
    ...
    public void setOrganType(String bloodGroup) {        this.organType = organType;    }
    ...
    public boolean isInheritedDisease() {        return inheritedDisease;}
    public void setInheritedDisease(boolean inheritedDisease) {        this.inheritedDisease = inheritedDisease;    }
    ...
    public boolean isDrugAddict() {        return drugAddict;    }
    public void setDrugAddict(boolean drugAddict) {        this.drugAddict = drugAddict;    }
