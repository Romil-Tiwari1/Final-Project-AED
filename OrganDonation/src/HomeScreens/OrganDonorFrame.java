 ...
 * @author romiltiwari
 */
public class OrganDonorFrame extends javax.swing.JFrame {

    /**
     * Creates new form OrganDonorFrame
     */
    public OrganDonorFrame(String type, EcoSystem system) {
        initComponents();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(OrganDonorFrame.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new OrganDonorFrame().setVisible(true);
            }
        });
    }
