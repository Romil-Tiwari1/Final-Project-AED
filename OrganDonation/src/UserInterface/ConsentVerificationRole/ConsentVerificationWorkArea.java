 ...
 */
public class ConsentVerificationWorkArea extends javax.swing.JPanel {
    ...
    public ConsentVerificationWorkArea(UserAccount account, ConsentVerificationOrganization consentVerificationOrganization, Enterprise enterprise, EcoSystem business, Network network) {
        initComponents();
        this.system = system;
    ...
    private void BtnManageRequestsMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_BtnManageRequestsMouseClicked
        // TODO add your handling code here:
       OfficerConsentRequestJPanel officerConsentRequestJPanel = new OfficerConsentRequestJPanel(system, userAccount, consentVerificationOrganization, enterprise);
        userProcessContainer.add("officerConsentRequestJPanel",officerConsentRequestJPanel);
        CardLayout layout = (CardLayout) userProcessContainer.getLayout();
        layout.next(userProcessContainer);
    ...
    private void BtnProfileMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_BtnProfileMouseClicked
        // TODO add your handling code here:
        ConsentOfficerProfile manageConcentOfficerProfile = new ConsentOfficerProfile(userAccount,consentVerificationOrganization,enterprise);
        userProcessContainer.add("manageConcentOfficerProfile",manageConcentOfficerProfile);
        CardLayout layout = (CardLayout) userProcessContainer.getLayout();
        layout.next(userProcessContainer);
